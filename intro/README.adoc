...
8. Refactoring some code to use reactive programming with the widely used RxJava library and its Vert.x integration.
...
Incoming network data is being received from accepting threads and then are then passed as events to the corresponding verticles.
...
Finally, verticles have a simple start / stop life-cycle, and verticles can deploy other verticles as the remainder of the guide will show.

...
To illustrate how working with JWT tokens work, let's create a new one for the `root` user:
...
The response text is the token value and shall be retained for API further access.
